...
//{
//	internal class ExcelRichTextHtmlUtility
//	{
//		/// <summary>
...
//			foreach(Match m in Regex.Matches(html, @"<(/?[a-z]+)[^<>]*>([\s\S]*?)(?=</?[a-z]+[^<>]*>|$)", RegexOptions.Compiled | RegexOptions.IgnoreCase))
//			{
//				if(isFirst)
//				{
...
//				string text = CleanText(m.Groups[2].Captures[0].Value);
